...
import styles from "./Projects.module.css" // Importa os estilos específicos para o componente
import { useState, useEffect } from "react" // Importa hooks do React

// Define o componente funcional Projects
function Projects() {
    ...
    useEffect(() => {
        ...
        },) // para Atraso de 1 segundos colocar "1000  "
    ...
    function removeProject(id) {
        // Reseta a mensagem antes de iniciar o processo de remoção
        setProjectMessage('')
